...
- Dashboard automatic coverage signal counts now include transfer coverage gaps
...
- Automated coverage now spans 237 tests across scheduler, session, sync, stats helpers, hooks, word-library workflows, and vocabulary pipeline helpers
