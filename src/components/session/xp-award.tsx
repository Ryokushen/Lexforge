        ...
        <CardContent className="space-y-6">
          {summary.leveledUp && (
            <motion.div
              ...
              className="text-center py-3 rounded-xl bg-gradient-to-r from-amber-500/10 via-yellow-500/15 to-amber-500/10 border border-amber-500/20"
            >
          ...
          >
            ...
            <div className="text-center rounded-lg bg-muted/50 p-3">
              ...
              <div className="text-xl font-semibold tabular-nums">{accuracy}%</div>
